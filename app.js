...
// is refers to the object itself which can be used to get into the object attributes 
// 2. What is "this" when joe.scopeArrow() is invoked?
// joe wont have it own binding to this or super 
//
// 3. Explain why "this" is different when an arrow function is used.
// Because we have to specify the scope of this when its inside arrow function so it does not mark the function itself
//
